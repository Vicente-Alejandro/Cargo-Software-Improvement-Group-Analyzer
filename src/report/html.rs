...
footer { text-align: center; color: var(--text-muted); font-size: 0.85rem; margin-top: 3rem; border-top: 1px solid var(--border); padding-top: 1.5rem; }
...
impl HtmlCtx<'_> {
    ...
    fn render_doc_end(&mut self) {
        self.out.push_str("<footer>Generated by <strong><a href=\"https://crates.io/crates/cargo-sig\" target=\"_blank\" rel=\"noopener noreferrer\">cargo-sig</a></strong> — Software Improvement Group Static Analyzer for Rust &bull; <a href=\"https://github.com/Vicente-Alejandro/Cargo-Software-Improvement-Group-Analyzer\" target=\"_blank\" rel=\"noopener noreferrer\">GitHub</a> &bull; <a href=\"https://crates.io/crates/cargo-sig\" target=\"_blank\" rel=\"noopener noreferrer\">Crates.io</a></footer>\n");
